...
Where the graph representing this orchestration is the following: 
...
-The same Agents and Tools as before (Analytics Agent with "get_roi", "get_cpc", "get_cpa", "get_ctr", "get_cvr" and a Retriever Agent with a "retriever_tool")
...
Where the graph representing this second orchestration is the following: 
