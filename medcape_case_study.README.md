...
## What it is
In this project. You'll find two solutions to the challenge. I wanted to present two different solutions so I can answer the question to how is the solution scalable and friendlier with produ
...
and a Visualization Agent for easier understanding of the models decisions and calculation using primarily matplotlib.
